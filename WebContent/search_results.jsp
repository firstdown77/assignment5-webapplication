...
<body>
	...
	%>
		<tr class="normalborder">
			<td class="normalborder"><a href="view_report?report_id=<%=r.get_id()%>"><%=r.getTitle()%></a></td>
			<td class="normalborder"><%= r.getUser() %></td>
			<td class="normalborder"><a href='view_file?filename=<%= r.getFilename() %>' target='_blank'><%= r.getFilename() %></a></td>
		</tr>
		<% } %>
	</table>
</body>
